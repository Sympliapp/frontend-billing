...
return (
<>
    <div className='flex flex-col mt-35 p-2'>

    <h1 className="text-3xl font-semibold text-center mx-auto mt-7">About our apps</h1>
    <p className="text-sm text-slate-500 text-center mt-2 max-w-lg mx-auto p-2">
        A visual collection of our most recent works - each piece crafted with intention, emotion and style.
    </p>
    <div className="relative  mx-auto grid grid-cols-1 md:grid-cols-2 md:px-4 lg:grid-cols-3 gap-10 px-4 md:px-0 pt-9 mb-40">
        <div className="left-1/2 -translate-x-1/2 rounded-full absolute blur-[300px] -z-10 bg-[#FBFFE1]"></div>
        <div>
