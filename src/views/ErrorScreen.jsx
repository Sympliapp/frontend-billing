...
const ErrorScreen = () => {
  return (
  <div class="flex flex-col items-center justify-center text-sm max-md:px-4 mt-[20vh]">
      <h1 class="text-7xl md:text-9xl font-bold text-indigo-500">404</h1>
      ...
      <div class="flex flex-col md:flex-row items-center gap-4 mt-6">
          <a href="#" class="bg-gray-800 hover:bg-black px-14 py-2.5 text-white rounded-md active:scale-95 transition-all">
              Return Home
          </a>
          <a href="#" class="border border-gray-300 px-12 py-2.5 text-gray-800 rounded-md active:scale-95 transition-all">
              Contact support
          </a>
      </div>
  </div>
